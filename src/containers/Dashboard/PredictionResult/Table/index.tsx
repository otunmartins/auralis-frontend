...
export const ContentByAnima = () => {
  ...
  const [data] = useState<MoleculeData[]>(initialData);
  ...
  return (
    <>
      <div className="h-[509px] overflow-auto border border-solid border-[#e9e9eb] bg-[#f8f8f8]">
        <Table>
              ...
              >
                ...
                <TableCell className="px-6 py-[26px] border-b border-[#e9e9eb]">
                  ...
                  >
                    ...
                    {/* <span
                      className={`font-medium text-xs text-center leading-[18px] whitespace-nowrap`}
                    >
                      {molecule.riskLevel.level}
                    </span> */}
                  </Badge>
